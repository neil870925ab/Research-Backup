...
MODEL_DIR = '/media/vchd/新增磁碟區/Neil/Research/REV/src/seq2seq_converter/model_data/question-converter-t5-3b'
...
for split in SPLIT:
    INPUT_CSV = f'/media/vchd/新增磁碟區/Neil/Research/dataset/ecqa/output_dir/ecqa_data_{split}.csv'
    OUTPUT_JSONL = f'/media/vchd/新增磁碟區/Neil/Research/REV/generated_baseline_rationales/ECQA/baseline_rationales_{split}_output.jsonl'
